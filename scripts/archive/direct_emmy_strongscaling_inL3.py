...
def main():
    ...
    exp_name = "emmy_1thread_strongscaling_in_L3_f2p2GHz_at_%s" % (hostname)  
    ...
    nz = 32
    nx = 512
    #for ny in range(48, 81, 8):
    #for ny in range(24, 48, 8):
    #for ny in range(88, 161, 8):
    for ny in range(168, 241, 8):
        outfile=(exp_name + '_ny_%d' % (ny))
        nt = 1000

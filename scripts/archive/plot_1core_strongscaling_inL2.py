...
#    ('Sustained L2 BW', 2), ('Total L2 Transfer',2),
  ...
  lns = lns + ax1.plot([0, max(x)], [ECM_inL2, ECM_inL2], color='k', linestyle='--', label='ECM in L2')
  plt.ylim([0, 1300])
  ...
  title = 'In L2 problem_nx=512_nz=2_Ivy Bridge 1-core strongscaling, 7_pt const. stencil SP '
  plt.title(title)

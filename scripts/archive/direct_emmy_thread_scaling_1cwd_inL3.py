...
"""export OMP_NUM_THREADS=$thn; likwid-perfctr -s 0x03 -g L3 -C S0:0-$th $exec_path --n-tests 2 --disable-source-point --npx 1 --npy 1 --npz 1 --nx 512 --ny 128 --nz 16  --verbose 1 --target-ts $ts --wavefront $wf --nt 10000 --target-kernel $kernel --t-dim $tb | tee $outfile""")
...
def main():
    ...
    exp_name = "emmy_socket_thread_scaling_1cwd_inL3_1to10_threads_f2p2GHz_at_%s" % hostname  

...
def plot_lines(raw_data, stencil_kernel, is_dp, t):
    ...
    fig_width = 3.1*0.393701 # inches
    fig_height = 1.5*fig_width #* 210.0/280.0#433.62/578.16
...
#    sus_mem_bw = 36500 #SB
    ...
    if stencil_kernel == 0:
        title = '25_pt_const_inL3'
    elif stencil_kernel == 1:
        title = '7_pt_const_inL3'
    elif stencil_kernel == 4:
        title = '25_pt_var_inL3'
    ...
    if stencil_kernel == 1: plt.legend(loc='best')
    plt.grid()

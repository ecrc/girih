...
ibrun tacc_affinity $exec_path --n-tests 2 --disable-source-point --halo-concatenate 1 --target-ts $ts --t-dim $t_dim --npx $npx --npy $npy --npz $npz --nx $nx --ny $ny --nz $nz --nt $nt 
...
def main():
    ...
    exp_name = "stampede_strongscaling_intra_diamond_1024cube"  

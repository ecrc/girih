...
ibrun tacc_affinity $exec_path --n-tests 2 --disable-source-point --target-ts $ts --t-dim $t_dim --npx $npx --npy $npy --npz $npz --nx $nx --ny $ny --nz $nz --nt $nt --z-mpi-contig $is_contig --halo-concatenate 1
...
def main():
    ...
    exp_name = "stampede_strongscaling_halo_first_y_decomp_concat_1024cube"  

...
static inline void exchange_halo_concat_asynch(Parameters *p, FLOAT_PRECISION * restrict u, FLOAT_PRECISION * restrict x_send_buf, FLOAT_PRECISION * restrict x_recv_buf, FLOAT_PRECISION * restrict y_send_buf, FLOAT_PRECISION * restrict y_recv_buf) {
  MPI_Request wait_req[3][4];
...
static inline void exchange_halo_asynch(Parameters *p, FLOAT_PRECISION * restrict u, FLOAT_PRECISION * restrict x_send_buf, FLOAT_PRECISION * restrict x_recv_buf, FLOAT_PRECISION * restrict y_send_buf, FLOAT_PRECISION * restrict y_recv_buf) {
  if(p->halo_concat == 1){
